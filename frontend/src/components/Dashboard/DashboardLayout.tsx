  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      <div className="flex">
        ...
        {/* Sidebar Navigation */}
        <div className={`w-64 bg-gray-900 dark:bg-gray-800 min-h-screen fixed left-0 top-0 z-40 transform transition-transform duration-300 ease-in-out ${
          isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
        } md:translate-x-0 md:block md:sticky md:h-screen md:overflow-y-auto`}>
          <div className="p-4">
        ...
        {/* Main Content */}
        <div className="flex-1 w-full pt-16 md:pt-0 bg-white dark:bg-gray-900">
          {children}
        </div>
      </div>
    </div>
